<?php
	...
	//	echo $EmailID;
		...
		$qry="SELECT count(*) as cnt,Password,EmailID FROM PM_User_Register where (EmailID='".$EmailID."' OR MobileNo='".$EmailID."')";
		//echo $qry;
		...
		if($row["cnt"]==1){
			...
			$response["success"] = 0;
        	$response["message"] = "No Such User Found With This Email!!";
			echo json_encode($response);
		}
	}
	else{
